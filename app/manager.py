...
# ── M-4: Market Status (kept for backward compat, redirects to dashboard) ──
...
# ── M-5: Sales Summary (kept for backward compat, redirects to dashboard) ──
...
# ── Backward compat aliases (send_market_detail_status used nowhere now) ───
